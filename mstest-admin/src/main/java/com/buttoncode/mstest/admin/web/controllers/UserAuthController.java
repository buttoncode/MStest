...
@Controller
public class UserAuthController extends MStestAdminBaseController
{
	...
	@RequestMapping(value="/forgotPwd", method=RequestMethod.POST)//wysylanie tokena na maila
	...
	@RequestMapping(value="/resetPwd", method=RequestMethod.GET)//otwieranie tokena
